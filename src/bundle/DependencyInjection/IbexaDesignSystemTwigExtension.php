...
namespace Ibexa\Bundle\DesignSystemTwig\DependencyInjection;
...
final class IbexaDesignSystemTwigExtension extends Extension implements PrependExtensionInterface
{
    /**
